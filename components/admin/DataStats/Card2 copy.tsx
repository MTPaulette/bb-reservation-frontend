...
<div>
  ...
  <span 
  className={`
    text-lg font-bold truncate px-2.5 py-0.5 rounded-full bg-opacity-15 dark:bg-opacity-30
    ${type === "pending"? "bg-meta-6 text-meta-6" : " "}
    ${type === "partially paid"? "bg-meta-4 text-meta-4" : " "}
    ${type === "confirmed"? "bg-meta-5 text-meta-5" : " "}
    ${type === "totally paid"? "bg-meta-3 text-meta-3" : " "}
    ${type === "cancelled"? "bg-meta-1 text-meta-1" : " "}
`}>
    {total}
  </span>
</div>
