...
export default function Alert({message, className}: {message: string, className: string }) {
  return (
    <div className={clsx("flex p-3 my-4 text-sm text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 dark:border-yellow-800", className )} role="alert">
