...
// import { TimeInput } from "@nextui-org/date-picker";

import { CalendarIcon, ViewColumnsIcon, CalendarDateRangeIcon, ClockIcon, ArrowRightStartOnRectangleIcon } from "@heroicons/react/24/outline";
...
export default function Reservations({
  ...
  return (
    ...
    <div className="">
      ...
      <div className="flex md:block justify-between items-end w-full m-6 md:mb-0 pl-0 ml-0">
        {/* <div>Filters: agency: {agency} validity: {validity} service_type: {service_type}</div> */}
        <SelectFilter placement="outside" items={allFilters} />
        <div className="flex items-center gap-x-4 md:w-full md:justify-end md:mt-5">
      ...
      <form className="w-full my-4 p-4 md:p-5 flex flex-wrap gap-y-5 items-center justify-between bg-content3 rounded-lg">
      ...
      <div className="w-full flex flex-wrap border border-red-100 items-center justify-between my-8">
